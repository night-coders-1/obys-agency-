...
const locoScroll = new LocomotiveScroll({
  ...
  smooth: true,
  // multiplier: 1, // optional tuning
});

// tell ScrollTrigger to use locomotive-scroll's scroll position instead of window scroll
ScrollTrigger.scrollerProxy("#main-content", {
  ...
  // Locomotive Scroll uses transform to move content on desktop
...
// refresh ScrollTrigger and update Locomotive Scroll on window resize/refresh
